module github.com/lansweeper-oss/provider-clickhouse
...
replace github.com/ClickHouse/terraform-provider-clickhouse => ./third_party/terraform-provider-clickhouse
