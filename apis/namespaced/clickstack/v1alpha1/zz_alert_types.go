...
type AlertInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/lansweeper-oss/provider-clickhouse/apis/namespaced/clickstack/v1alpha1.SavedSearch
...
type ChannelInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/lansweeper-oss/provider-clickhouse/apis/namespaced/clickstack/v1alpha1.Webhook
